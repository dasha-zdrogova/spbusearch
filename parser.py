...
def get_info_from_ep_desc(soup: BeautifulSoup):
    ...
    if target_header:
        ...
        for i in range(2, len(links)):
            for link in links[i]:
                ...
                if catalog_response.status_code == 200:
                    ...
                    assert isinstance(download_link := catalog.select_one(".primary.button"), element.Tag)
        ...
        print(
            "Заголовок 'Информация об описании образовательных программ' не найден на странице."
        )
